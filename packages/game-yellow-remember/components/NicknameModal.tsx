...
export default function NicknameModal({ score, maxGrid, onSubmitted, onSkip }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    setError('');
    try {
      const id = await submitScore(name, score, maxGrid);
      onSubmitted(id);
    } catch (e: any) {
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <View style={styles.card}>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.stat}>
              <Text style={styles.statLabel}>MAX GRID</Text>
              <Text style={[styles.statValue, { color: C.green }]}>{maxGrid}×{maxGrid}</Text>
            </View>
          </View>
